    ...
    context: [
      {
        role: "user",
        content:
          "写一个50字左右的短文案，用乐观、谦逊、娓娓道来的语言风格，今天要表达的是：",
        date: "",
      },
    ],
    modelConfig: {
    ...
    context: [
      {
        role: "user",
        content:
          "为我撰写一个约420字-450字的抖音口播短视频逐字稿，用说教、乐观和科学的语调分享您的工作经验，展示如何应对挑战，同时提供实用建议，文本中不用出现抖音口播短视频字样和用什么语调的关键词。我今天的话题是：",
        date: "",
      },
    ],
    modelConfig: {
    ...
    context: [
      {
        role: "user",
        content:
          "你是一位精通课程设计和文案写作的专家。你将根据我提供的课程主题，主动考虑课程应该针对的目标人群，归纳出课程对于目标人群的意义和卖点，为课程设计一个不超过10节课的教学大纲并写出引人入胜的课程标题。我提供的课程主题是：",
        date: "",
      },
    ],
    modelConfig: {
